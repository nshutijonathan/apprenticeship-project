...
class Query(AuthQuery, business_query.Query, outlet_schema.Query, graphene.ObjectType):
    pass


class Mutation(AuthMutation, business_mutation.Mutation, outlet_mutation.Mutation, graphene.ObjectType):
